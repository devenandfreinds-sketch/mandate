...
export const sources: SourceSeedSpec[] = [
  ...
  {
    key: "gmca_decision_records",
    name: "GMCA Decision Records",
    publisher: "Greater Manchester Combined Authority",
    url: "https://democracy.greatermanchester-ca.gov.uk/",
    sourceType: "government_report",
    citation: "GMCA's published committee/delegated-decision records, the formal instrument by which the Combined Authority approves individual funding awards and governance actions.",
    isPlaceholder: false,
    updateFrequency: "as_needed",
    defaultConfidence: "high",
    country: "United Kingdom",
  ...
  {
    key: "gmmh_mhtas",
    name: "Greater Manchester Mental Health NHS Foundation Trust — MHTAS Reporting",
    ...
    sourceType: "government_report",
    citation: "GMMH's own reporting on the Mental Health Tactical Advice Service (MHTAS), the four-way GMP/NHS partnership providing real-time clinical guidance for police mental-health-crisis calls.",
    isPlaceholder: false,
    updateFrequency: "as_needed",
    defaultConfidence: "high",
    country: "United Kingdom",
  ...
  {
    key: "gmp_rcrp",
    name: "Greater Manchester Police — Right Care, Right Person",
    ...
    sourceType: "government_report",
    citation: "GMP's own public-facing page on Right Care, Right Person (RCRP), the national policing policy diverting non-crime mental-health/welfare calls away from police response, as implemented in Greater Manchester.",
    isPlaceholder: false,
    updateFrequency: "as_needed",
    defaultConfidence: "high",
    country: "United Kingdom",
  ...
  {
    key: "govuk_rcrp_evaluation",
    name: "GOV.UK — Evaluating the Implementation of Right Care, Right Person",
    ...
    sourceType: "government_report",
    citation: "The national process evaluation of RCRP implementation, covering a sample of English police forces -- Greater Manchester Police was not among the named process-evaluation or data-monitoring forces in this evaluation.",
    isPlaceholder: false,
    updateFrequency: "one_time",
    defaultConfidence: "high",
    country: "United Kingdom",
  ...
  {
    key: "judiciary_pfd_reports",
    name: "Judiciary.uk — Prevention of Future Deaths Reports",
    publisher: "HM Courts & Tribunals Service (Coroners)",
    url: "https://www.judiciary.uk/",
    sourceType: "government_report",
    citation: "Coronial Prevention of Future Deaths reports and the responding public authority's published reply, used here for a Greater Manchester Police response documenting concerns with a Right Care, Right Person-related welfare-call case.",
    isPlaceholder: false,
    updateFrequency: "as_needed",
    defaultConfidence: "high",
    country: "United Kingdom",
  ...
  {
    key: "gcangels_tef",
    name: "GC Angels / The Enterprise Fund Limited",
    publisher: "The Enterprise Fund Limited (a Growth Company subsidiary)",
    url: "https://gcangels.uk/",
    sourceType: "financial_data",
    citation: "GC Angels' own reporting on its early-stage investment activity, delivered as a commissioned GMCA-funded programme by The Enterprise Fund Limited (FCA-regulated, FRN 727252).",
    isPlaceholder: false,
    updateFrequency: "as_needed",
    defaultConfidence: "medium",
    country: "United Kingdom",
  ...
  {
    key: "business_money_trade_press",
    name: "Business Money — UK Angel/VC Trade Press",
    publisher: "Business Money",
    url: "https://business-money.com/",
    sourceType: "news",
    citation: "UK SME-finance trade press, used here to independently corroborate GC Angels' investment activity beyond its own self-reporting.",
    isPlaceholder: false,
    updateFrequency: "continuous",
    defaultConfidence: "medium",
    country: "United Kingdom",
  ...
  // =========================================================
  // DSA clean-out pass, workforce cluster (see docs/DSA_RESEARCH_MASTER_REPORT.md). NYC,
  // Minneapolis, Seattle, and DC each needed real unemployment/labor-force/wage/employment
  // data pulled from BLS/state-agency primary sources -- see per-city methodology notes for
  // which geography (city-proper vs. metro-area, an unavoidable BLS scope limit for wages
  // and total-nonfarm employment in most cities) each series actually covers.
  // =========================================================
  {
    key: "bls_laus_nyc",
    name: "BLS Local Area Unemployment Statistics — New York City",
    publisher: "U.S. Bureau of Labor Statistics (LAUS program, with NYS DOL)",
    url: "https://www.bls.gov/regions/northeast/data/xg-tables/ro2xglausnyc.htm",
    sourceType: "government_dataset",
    citation: "BLS LAUS, 'New York City' area (Bronx, Kings, New York, Queens, and Richmond Counties), annual average unemployment rate, not seasonally adjusted.",
    isPlaceholder: false,
    updateFrequency: "monthly",
    defaultConfidence: "high",
    country: "United States",
  ...
  {
    key: "census_acs_dp03_nyc",
    name: "Census ACS Table DP03 — New York City",
    publisher: "U.S. Census Bureau (American Community Survey)",
    url: "https://data.census.gov/",
    sourceType: "government_dataset",
    citation: "Census ACS 1-Year Estimates, Table DP03 'Selected Economic Characteristics,' labor force participation rate (population 16+), New York City.",
    isPlaceholder: false,
    updateFrequency: "annual",
    methodology: "OSC (NYS Comptroller) notes a methodology shift over the 2015-2025 window from LAUS-based to CPS-based annualized estimates -- treat as not perfectly continuous if stitched into one series.",
    defaultConfidence: "high",
    country: "United States",
    language: "en",
  },
  {
    key: "bls_oews_nyc_metro",
    name: "BLS Occupational Employment and Wage Statistics — New York-Newark-Jersey City Metro",
    publisher: "U.S. Bureau of Labor Statistics (OEWS program)",
    url: "https://www.bls.gov/oes/",
    sourceType: "government_dataset",
    citation: "BLS OEWS, New York-Newark-Jersey City, NY-NJ-PA MSA (area code 35620), 'All Occupations' median hourly wage, annualized at 2,080 hours/year per BLS's own OEWS convention.",
    isPlaceholder: false,
    updateFrequency: "annual",
    methodology: "OEWS does not publish sub-MSA (city-level) wage estimates -- this MSA spans 22 counties across NY, NJ, and PA, not just the 5 boroughs. Imported as a metro-area proxy for NYC's median wage, not a city-proper figure, and flagged accordingly.",
    defaultConfidence: "medium",
    country: "United States",
    language: "en",
  },
  {
    key: "bls_ces_nyc",
    name: "BLS Current Employment Statistics — New York City",
    publisher: "U.S. Bureau of Labor Statistics (CES program, Northeast Information Office)",
    url: "https://www.bls.gov/regions/northeast/news-release/areaemployment_newyork.htm",
    sourceType: "government_dataset",
    citation: "BLS CES 'New York City, NY' area breakout (explicitly defined as the 5 boroughs within the New York-Jersey City-White Plains metropolitan division), total nonfarm employment, not seasonally adjusted.",
    isPlaceholder: false,
    updateFrequency: "monthly",
    defaultConfidence: "high",
    country: "United States",
  ...
  {
    key: "mn_deed_laus_minneapolis",
    name: "Minnesota DEED Local Area Unemployment Statistics — Minneapolis",
    publisher: "Minnesota Department of Employment and Economic Development (DEED)",
    url: "https://apps.deed.state.mn.us/lmi/laus/",
    sourceType: "government_dataset",
    citation: "MN DEED LAUS, Minneapolis city-level series (place of residence), monthly labor force/employment/unemployment counts and rate, not seasonally adjusted.",
    isPlaceholder: false,
    updateFrequency: "monthly",
    defaultConfidence: "high",
    country: "United States",
  ...
  {
    key: "census_acs_dp03_minneapolis",
    name: "Census ACS Table DP03 — Minneapolis",
    publisher: "U.S. Census Bureau (American Community Survey)",
    url: "https://data.census.gov/",
    sourceType: "government_dataset",
    citation: "Census ACS 1-Year Estimates, Table DP03, labor force participation rate (population 16+), Minneapolis city, Minnesota.",
    isPlaceholder: false,
    updateFrequency: "annual",
    defaultConfidence: "high",
    country: "United States",
  ...
  {
    key: "bls_oews_msp_metro",
    name: "BLS Occupational Employment and Wage Statistics — Minneapolis-St. Paul-Bloomington Metro",
    publisher: "U.S. Bureau of Labor Statistics (OEWS program)",
    url: "https://www.bls.gov/oes/",
    sourceType: "government_dataset",
    citation: "BLS OEWS, Minneapolis-St. Paul-Bloomington, MN-WI MSA (area code 33460), 'All Occupations' median hourly wage, annualized at 2,080 hours/year.",
    isPlaceholder: false,
    updateFrequency: "annual",
    methodology: "OEWS does not publish city-level wage estimates -- this MSA spans parts of Minnesota and Wisconsin, not just Minneapolis. Imported as a metro-area proxy, flagged accordingly.",
    defaultConfidence: "medium",
    country: "United States",
    language: "en",
  },
  {
    key: "bls_ces_msp_metro",
    name: "BLS Current Employment Statistics — Minneapolis-St. Paul-Bloomington Metro",
    publisher: "U.S. Bureau of Labor Statistics (CES program)",
    url: "https://data.bls.gov/timeseries/SMS27334600000000001",
    sourceType: "government_dataset",
    citation: "BLS CES, Minneapolis-St. Paul-Bloomington, MN-WI MSA (series SMS27334600000000001), total nonfarm employment, seasonally adjusted, December value of each year.",
    isPlaceholder: false,
    updateFrequency: "monthly",
    methodology: "CES does not produce a Minneapolis-city-specific total nonfarm employment series -- MSA-level only. Imported as a metro-area proxy, flagged accordingly.",
    defaultConfidence: "medium",
    country: "United States",
    language: "en",
  },
  {
    key: "bls_laus_seattle",
    name: "BLS Local Area Unemployment Statistics — Seattle",
    publisher: "U.S. Bureau of Labor Statistics (LAUS program, with WA ESD)",
    url: "https://data.bls.gov/timeseries/LAUCT536300000000003",
    sourceType: "government_dataset",
    citation: "BLS LAUS, series LAUCT536300000000003, 'Unemployment Rate: Seattle city, WA,' not seasonally adjusted, December value of each year.",
    isPlaceholder: false,
    updateFrequency: "monthly",
    defaultConfidence: "high",
    country: "United States",
  ...
  {
    key: "census_acs_seattle",
    name: "Census ACS — Seattle Labor Force Participation",
    publisher: "U.S. Census Bureau (American Community Survey)",
    url: "https://www.census.gov/quickfacts/fact/table/seattlecitywashington",
    sourceType: "government_dataset",
    citation: "Census ACS 5-Year Estimates, Table DP03 / QuickFacts, civilian labor force participation rate (population 16+), Seattle city, Washington.",
    isPlaceholder: false,
    updateFrequency: "annual",
    methodology: "Only two vintages located this pass (2009-2013 5-year estimate and 2020-2024 5-year estimate) -- both genuinely city-level, but sparse and on different 5-year windows rather than a continuous annual series.",
    defaultConfidence: "high",
    country: "United States",
    language: "en",
  },
  {
    key: "bls_oews_seattle_metro",
    name: "BLS Occupational Employment and Wage Statistics — Seattle-Tacoma-Bellevue Metro",
    publisher: "U.S. Bureau of Labor Statistics (OEWS program)",
    url: "https://www.bls.gov/oes/",
    sourceType: "government_dataset",
    citation: "BLS OEWS, Seattle-Tacoma-Bellevue, WA MSA (area code 42660; prior to ~2020 published as the narrower Seattle-Bellevue-Everett Metropolitan Division, area code 42644 -- not directly comparable), 'All Occupations' wage statistics.",
    isPlaceholder: false,
    updateFrequency: "annual",
    methodology: "OEWS does not publish city-level wage estimates -- this MSA spans King, Pierce, and Snohomish counties, not just Seattle. Imported as a metro-area proxy, flagged accordingly. The area definition itself changed (MD retired, full MSA used) between 2017 and 2020, so early and late years in this series are not on an identical geography even within the 'metro proxy' caveat.",
    defaultConfidence: "medium",
    country: "United States",
    language: "en",
  },
  {
    key: "bls_ces_seattle_metro",
    name: "BLS Current Employment Statistics — Seattle-Tacoma-Bellevue Metro",
    publisher: "U.S. Bureau of Labor Statistics (CES program)",
    url: "https://fred.stlouisfed.org/series/SMU53426600000000001A",
    sourceType: "government_dataset",
    citation: "BLS CES via FRED series SMU53426600000000001A, Seattle-Tacoma-Bellevue, WA MSA, total nonfarm employment, annual average, not seasonally adjusted.",
    isPlaceholder: false,
    updateFrequency: "annual",
    methodology: "CES does not produce a Seattle-city-specific total nonfarm employment series -- MSA-level only (King, Pierce, and Snohomish counties). Imported as a metro-area proxy, flagged accordingly.",
    defaultConfidence: "medium",
    country: "United States",
    language: "en",
  },
  {
    key: "bls_laus_dc",
    name: "BLS Local Area Unemployment Statistics — District of Columbia",
    publisher: "U.S. Bureau of Labor Statistics (LAUS program)",
    url: "https://data.bls.gov/timeseries/LASST110000000000003",
    sourceType: "government_dataset",
    citation: "BLS LAUS, series LASST110000000000003, 'Unemployment Rate: District of Columbia,' not seasonally adjusted, annual average computed from official monthly values.",
    isPlaceholder: false,
    updateFrequency: "monthly",
    defaultConfidence: "high",
    country: "United States",
  ...
  },
  {
    ...
    sourceType: "government_report",
    citation: "DC DOES monthly labor-market press releases, labor force participation rate, sourced from the District's portion of the national Current Population Survey (CPS/LAUS).",
    isPlaceholder: false,
    updateFrequency: "monthly",
    methodology: "Only scattered individual months (not a clean annual series) were located across the 2022-2025 window this pass; seasonal-adjustment status of the LFPR line specifically (as opposed to the unemployment rate line, which is explicitly labeled) was not confirmed.",
    defaultConfidence: "medium",
    country: "United States",
    language: "en",
  },
  {
    key: "bls_oews_dc",
    name: "BLS Occupational Employment and Wage Statistics — District of Columbia",
    publisher: "U.S. Bureau of Labor Statistics (OEWS program)",
    url: "https://www.bls.gov/oes/",
    sourceType: "government_dataset",
    citation: "BLS OEWS, District of Columbia state-level estimate (DC's own OEWS geography, not a multi-jurisdiction metro division), 'All Occupations' median hourly wage, annualized at 2,080 hours/year per BLS's own OEWS convention.",
    isPlaceholder: false,
    updateFrequency: "annual",
    methodology: "Unlike NYC/Minneapolis/Seattle, DC is its own clean OEWS geography (a state-equivalent), so this is a genuine city-proper figure, not a metro-area proxy. BLS switched to XLSX-only bulk files for state-level OEWS data starting with the May 2024 reference period, so only 2016-2023 were extracted this pass; 2024/2025 require pulling the bulk XLSX files directly.",
    defaultConfidence: "high",
    country: "United States",
    language: "en",
  },
  {
    key: "bls_ces_dc",
    name: "BLS Current Employment Statistics — District of Columbia",
    publisher: "U.S. Bureau of Labor Statistics (CES program)",
    url: "https://data.bls.gov/timeseries/SMS11000000000000001",
    sourceType: "government_dataset",
    citation: "BLS CES, series SMS11000000000000001, 'All Employees, Total Nonfarm, District of Columbia,' seasonally adjusted, annual average.",
    isPlaceholder: false,
    updateFrequency: "monthly",
    defaultConfidence: "high",
    country: "United States",
  ...
  // =========================================================
  // DSA clean-out pass, housing cluster (see docs/DSA_RESEARCH_MASTER_REPORT.md). All four cities'
  // housing_permits_issued figures are computed directly from the U.S. Census Bureau's raw
  // place-level Building Permits Survey (BPS) annual files, the same primary source and methodology
  // across all four -- deliberately not the higher-level administrative figures some cities'
  // planning departments separately publish, which were found to diverge (see NYC/DC below).
  // =========================================================
  {
    key: "census_bps_place_level",
    name: "U.S. Census Bureau Building Permits Survey (BPS) — Place-Level Annual Data",
    publisher: "U.S. Census Bureau, Manufacturing and Construction Division",
    url: "https://www.census.gov/construction/bps/",
    sourceType: "government_dataset",
    citation:
      "Census Bureau BPS, place-level annual permit files, new privately-owned housing units authorized by building permit (a units count, not a structures/buildings count -- a single permit can cover many units).",
    isPlaceholder: false,
    updateFrequency: "annual",
    methodology:
      "New York City requires summing across its five separately-reported borough rows (Bronx, Brooklyn, Manhattan, Queens, Staten Island) -- Census does not publish one combined 'New York city' row. This directly-computed BPS total diverges materially in some years from NYC's own Department of City Planning administrative permit count (e.g. 2022: Census BPS 21,490 vs. DCP 68,668; 2023: Census BPS 9,210 vs. DCP 16,420) -- DCP attributes the gap to a DOB reporting-system change. Mandate uses the raw Census BPS figure for cross-city consistency with Minneapolis, Seattle, and DC, which have no comparable administrative-count alternative.",
    defaultConfidence: "high",
    country: "United States",
    language: "en",
  },
  {
    key: "nyc_rgb_housing_supply_report",
    name: "NYC Rent Guidelines Board — Housing Supply Report / Income and Affordability Study",
    publisher: "New York City Rent Guidelines Board",
    url: "https://rentguidelinesboard.cityofnewyork.us/",
    sourceType: "government_report",
    citation:
      "NYC RGB's annual Housing Supply Report and Income and Affordability Study, which republish, with full sourcing, primary-agency data from NYC Department of City Planning (DCP, new housing units completed, i.e. Certificates of Occupancy issued), NYC Department of Homeless Services (DHS, sheltered census), and the Census Bureau (American Community Survey, median gross/contract rent; Housing and Vacancy Survey, net rental vacancy rate).",
    isPlaceholder: false,
    updateFrequency: "annual",
    methodology:
